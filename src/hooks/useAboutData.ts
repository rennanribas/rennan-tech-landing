...
export function useAboutData() {
  const experiences: Experience[] = [
    ...
    },
    {
      ...
      summary:
        'Delivered two parallel contract engagements as a senior full-stack engineer: acting as the core engineering team for an early-stage health product, and contributing as a senior developer to an enterprise purchase orders and invoices management system used in aerospace production.',
      highlights: [
        'Owned end-to-end architecture and delivery of an early-stage health product across backend, web, mobile, data, and cloud, working directly with founders on product direction and technical evolution.',
        'Built a React web application with TypeScript and Redux and backend services on NestJS and AWS Lambda with PostgreSQL and TimescaleDB, including ingestion pipelines with queue-based workers (BullMQ, Redis) for high-throughput health data.',
        ...
        'Owned cloud infrastructure on AWS (ECS, Fargate, Lambda, ECR, EC2) with Terraform, Docker, and CI/CD pipelines.',
        'Contributed as senior developer to a Purchase Orders and invoices management system for an aerospace manufacturer, delivering responsive web features (forms, tables, dashboards) in React and TypeScript with modern hooks.',
        'Managed NestJS backend services following clean code and Clean Architecture principles, with decoupled entities and repositories, PostgreSQL via TypeORM, optimized indexing, direct queries, seeders, and migrations for robust, scalable application design.',
      ],
      stack: [
        'TypeScript',
        'React',
