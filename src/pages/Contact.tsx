      ...
      <div className='grid lg:grid-cols-2 gap-12'>
        ...
        >
              ...
              {contactMethods.map((method, index) => {
                ...
                return (
                  <motion.a
                    ...
                    className='flex items-start gap-4 p-4 rounded-xl hover:bg-secondary/20 transition-colors group'
                  >
          ...
          <div className='bg-white rounded-2xl p-8 shadow-sm border border-mocha-200'>
            ...
            <p className='text-card-foreground/60 leading-relaxed mb-4'>
              I'm always interested in discussing new opportunities, whether
              it's a full-time position, consulting work, or an exciting project
              collaboration.
            </p>
